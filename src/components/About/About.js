        ...
        <div className="about" id="about">
            <div className="container">
                <div className="row d-flex align-items-center">
                    <div data-aos="fade-right" data-aos-offset="400" data-aos-duration="1000" className="col-md-6 pt-5 d-flex justify-content-center">
                        <img className="img-fluid" style={{ width: "330px" }} src={pic2} alt="" srcset="" />
                    </div>
                    <div data-aos="fade-left" data-aos-offset="400" data-aos-duration="1000" className="col-md-5 offset-md-1 pt-5 ">
